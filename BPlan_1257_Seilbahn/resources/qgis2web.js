...
map.getView().fit([790151.023547, 6662552.561930, 793882.488859, 6665052.302137], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BPlan 1257 - Seilbahn</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (316 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<p><strong>Kartenwerke</strong> entstammen der Kurzbegründung zum<br><br /><strong>BPlan 1257 – BUGA 3 Seilbahn/Talstation</strong></p><br /><br /><p>sowie der ökologischen Ersteinschätzung der<br><br /><strong>BSMW 2023</strong></p><br /><br /><p><a href="https://nabuwtal.uber.space/s/86PkMFABZxnefR8" target="_blank">Unterlagen ansehen</a></p>';
            }
