...
map.getView().fit([680101.380308, 6620128.345963, 828399.395817, 6720743.623339], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CO2 Pipeline Korridor</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (453 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<h3>Willkommen</h3><br />Diese Kartenanwendung zeigt den <br />Korridor der geplanten <b>CO2-Pipeline</b> in den Untersuchungsräumen:<br /><br />Köln /Wesseling, Gelsenkirchen-Scholven, Venlo<br /><br />In der Liste rechts oben (kann man ausblenden), gibt es zahlreiche (Umwelt-)Layer, die man zu- und abschalten kann.<br /><i>(Tipp: an/aus im Wechsel zeigt Element ganz gut. Nur Mut ;)</i><br /><br /><b><a href="https://nrw.social/@Scharpenacken">Menschenfreunde-Scharpenacken (Fediverse)</a><br>';
            }
