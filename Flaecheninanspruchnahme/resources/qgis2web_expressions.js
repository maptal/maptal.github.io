...
function exp_label_Windhvel_11_eval_expression(context) {
    // Name + ' - ' + Fläche

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Name')  + ' - ') + feature.get('Fläche') );
    } else {
        return ((feature.get('Name')  + ' - ') + feature.get('Fläche') );
    }
}
...
function exp_label_BuntenbeckGIB_12_eval_expression(context) {
    // Name + ' - ' + Fläche
...
function exp_label_WeitereSiedlungsflchenASB_13_eval_expression(context) {
    // Name + ' - ' + Fläche
...
function exp_label_28RPDnderung_14_eval_expression(context) {
    // Name + ' - ' + Fläche
