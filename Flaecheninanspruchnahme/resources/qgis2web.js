...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [780803.125000, 6650525.956786, 814127.000000, 6677770.525611],
            units: 'm'
        })
    })
});
...
map.getView().fit([777334.970118, 6649985.687500, 817595.154882, 6678432.812500], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Flächeninanspruchnahme Wuppertal</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (44 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '(C) Menschen- und Naturfreunde Scharpenacken';
            }
