...
map.getView().fit([801029.036558, 6659513.512406, 804879.354357, 6662178.241805], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BPlan 1203 - An den Friedhöfen, Ronsdorf (VO/0887/24)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1179 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<h3>Willkommen</h3><br /><br />Diese Kartenanwendug zeigt den <br />BPlan <b>1203</b> (An den Friedhöfen) in Ronsdorf.<br /><br />Der Kartenausschnitt ist so gewählt, dass er den Geltungsbereich des BPlan im Kontext des Einzugsgebiets des Kottsiepen zeigt <b>(lila Linie)</b>.<br /><br /><b>Hinweis:</b> Manche Layer liefern ihre Daten erst ab einem gewissen Maßstab.<br /><br />In der Liste rechts oben (kann man ausblenden), gibt es zahlreiche (Umwelt-)Layer, die man zu- und abschalten kann.<br /><i>(Tipp: an/aus im Wechsel zeigt Elemente ganz gut, wenn sie nicht auf den ersten Blick ersichtlich sind. Nur Mut ;)</i><br /><br />Die Frist für die Stellungnahme im Rahmen der öffentlichen Beteiligung läuft bis zum <b>20.1.25</b><br /><br /><a href="https://wunda-geoportal.cismet.de/#/docs/bplaene/1203/1/1?lat=-27.9375&lng=64.3125&zoom=4">Planunterlagen der Stadt</a><br /><br />Eine Übersicht über die Karten (WMS) der Stadt Wuppertal und deren Einbindung in z.B. das Geoportal NRW gibt es hier:<br /><a href="https://www.wuppertal.de/microsite/geoportal/themakarten/index.php">Geoportal Wuppertal</a><br /><br /><p>Verantwortlich für den Inhalt dieser Seiten<br />  <a href="mailto:maptal@menschenfreunde-scharpenacken.de">Menschen- und Naturfreunde Scharpenacken</a><br /></p>';
            }
