...
lyr_Quartiere_2.set('fieldLabels', {'QUARTIER': 'inline label - visible with data', 'NAME': 'inline label - visible with data', 'Fläche': 'inline label - visible with data', });
lyr_Bezirke_3.set('fieldLabels', {'BEZIRK': 'inline label - visible with data', 'NAME': 'inline label - visible with data', 'Fläche': 'inline label - visible with data', });
lyr_Stadtgebiet_4.set('fieldLabels', {'STADT': 'inline label - visible with data', 'Fläche2': 'inline label - visible with data', });
