...
map.getView().fit([652719.662566, 6616934.830653, 877765.774460, 6791111.893293], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Siedlungsflächenmonitoring (SFM) 2009-2023 (Planungsregion Düsseldorf)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (2251 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<head><br /><base target="_blank" rel="noopener noreferrer"><br /></head><br /><b>Daten und Unterlagen zum kontinuierlichen Siedlungsflächenmonitoring der Planungsregion Düsseldorf</b><br />Anfrage an Bezirksregierung Düsseldorf: <a href="https://fragdenstaat.de/a/324857">Frag den Staat</a><br /><p><i>Insoweit von hier aus richtig, erfolgt die Datenerhebung zum kontinuierlichen Siedlungsflächenmonitoring (SFM) seit 2009 digital in Form von GIS-Daten.<br />Hierzu bitte ich um die Daten des kontinuierlichen Siedlungsflächenmonitorings für den <b>Regierungsbezirk Düsseldorf</b>, erhoben seit 2009, mit Stand der jeweiligen Stichtage. Bitte stellen Sie die Daten, sofern möglich, in digitaler Form (z. B. als Shape-Dateien oder in einem anderen gängigen GIS-Format) bereit.<br />Weiter beantrage ich Ihnen vorliegende Kommunikation und Vereinbarungen im Zusammenhang mit der Durchführung des Siedlungsflächenmonitorings in Bezug auf die Stadt Wuppertal, einschließlich interner und externer Abstimmungen, Berichten, Vereinbarungen oder anderen relevanten Unterlagen.</i></p><br /><br /><b>Ergebnis der Anfrage</b><br /><p>Die Daten wurden von der Bezirksregierung bis zum 07.04.2025 als Download zur Verfügung gestellt: <a href="https://fragdenstaat.de/anfrage/daten-und-unterlagen-zum-kontinuierlichen-siedlungsflaechenmonitoring/#nachricht-982436">Antwort der Bezirksregierung</a><br />Um diese langfristig verfügbar zu halten, wurden diese hier abgelegt: <a href="https://nabuwtal.uber.space/s/BE9PQ5JbETXym2i">NABU Wuppertal</a><br /></p><br /><b>Weiterführende Informationen:</b><br /><ul><br /><li><a href="https://www.brd.nrw.de/Themen/Planen-Bauen/Regionalentwicklung/Monitoring">Monitoring Bezirksregierung Düsseldorf</a><br /><li><a href="https://www.brd.nrw.de/Themen/Planen-Bauen/Regionalentwicklung/Monitoring/Siedlungsflaechenmonitoring">Handbuch SFM</a><br /><li><a href="https://www.brd.nrw.de/system/files/media/document/2023-09/20230905_3_32_Siedlungsfl%C3%A4chenmonitroring_2023.pdf">Rheinblick - Regionalmonitoring f.d. Planungsregion Düsseldorf (PDF)</a><br /><li><a href="https://landesplanung.nrw.de/aktuelle-fachthemen/siedlungsentwicklung-verkehr/siedlungsflaechenmonitoring">Land NRW - SFM</a><br /></ul><br /><p>(c) <a href="https://menschenfreundescharpenacken.wordpress.com">Menschen- und Naturfreunde Scharpenacken</a>';
            }
